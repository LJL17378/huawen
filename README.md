...
- 🎯 朝歌华文按诗集、朝代、诗人、诗词等方式检索，内容丰富，信息齐全
- 📝 朝歌华文按选集、主题、节日、节气、词牌、时令、地理等方式精选分类
- 🔍 朝歌华文全站响应式布局，兼容移动端，支持暗黑模式，响应速度快
...
开源版本的朝歌华文：https://haitang.vercel.app

现网版本的朝歌华文：https://haitang.app
...
- 部署平台的差异：开源版本的朝歌华文是部署在Vercel上，需要科学上网才能访问。现网版本的朝歌华文是部署在Netlify上，绑定了自购域名，所以国内可以直接访问。本项目是纯静态网站，也可以稍微修改代码在其他平台上部署，例如CloudFlare。
